# Generated by Django 2.2 on 2019-04-29 12:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('folder_key', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='p_dir', to='Mryang_App.Dir')),
            ],
        ),
        migrations.CreateModel(
            name='GalleryInfo',
            fields=[
                ...
                ('param1', models.CharField(default='', max_length=500)),
                ('param2', models.CharField(default='', max_length=500)),
                ('folder_key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dir', to='Mryang_App.Dir')),
            ],
        ),
    ]
