!function (a, b) {
    ...
    return function (a) {
                    ...
                    init: function (a) {
                        ...
                        if (q !== e) {
                            ...
                            r.on(c.JWPLAYER_MEDIA_LEVELS, function (a) {
                                ...
                                g.trigger.call(D, "connectFaild", a), g.trigger.call(D, c.JWPLAYER_MEDIA_ERROR, {message: "连接已断开，请稍后重试"})
        ...
        d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
            ...
            function m(m, x) {
                function y() {
                    xa && (ha(La.audioTracks), ra.setTextTracks(La.textTracks), La.setAttribute("jw-loaded", "data"), Ja.isLive && J())
                }

                function z() {
                    xa && La.setAttribute("jw-loaded", "started")
                }
                ...
                function D() {
                    n(va), ta = !0, xa && (ra.state === f.STALLED ? ra.setState(f.PLAYING) : ra.state === f.PLAYING && (va = setTimeout(_, o)), za && La.duration === 1 / 0 && 0 === La.currentTime || (I(H()), G(La.currentTime), F(aa(), oa, na), ra.state === f.PLAYING && (ra.trigger(e.JWPLAYER_MEDIA_TIME, {
                        position: oa,
                        duration: na
                    }), E())))
                }
                ...
                function E() {
                    var a = Ha.level;
                    if (a.width !== La.videoWidth || a.height !== La.videoHeight) {
                        if (a.width = La.videoWidth, a.height = La.videoHeight, la(), !a.width || !a.height) return;
                        Ha.reason = Ha.reason || "auto", Ha.mode = "hls" === qa[ya].type ? "auto" : "manual", Ha.bitrate = 0, a.index = ya, a.label = qa[ya].label, ra.trigger("visualQuality", Ha), Ha.reason = ""
                    }
                }

                function F(a, b, c) {
                    a === wa && c === na || (wa = a, ra.trigger(e.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a,
                        position: b,
                        duration: c
                    }))
                ...
                function H() {
                    var a = La.duration, b = Y();
                    if (a === 1 / 0 && b) {
                        var c = b - La.seekable.start(0);
                        c !== 1 / 0 && c > 120 && (a = -c)
                    }
                    return a
                }
                ...
                function I(a) {
                    na = a, ua && a && a !== 1 / 0 && ra.seek(ua)
                }

                function J() {
                    var a = H();
                    za && a === 1 / 0 && (a = 0);
                    var b = {duration: a, height: La.videoHeight, width: La.videoWidth};
                    ra.trigger(e.JWPLAYER_MEDIA_META, b), I(a)
                }
                ...
                function L() {
                    xa && (La.muted && (La.muted = !1, La.muted = !0), La.setAttribute("jw-loaded", "meta"), J())
                }

                function M() {
                    pa || (pa = !0, ra.trigger(e.JWPLAYER_MEDIA_BUFFER_FULL))
                }

                function N() {
                    ra.setState(f.PLAYING), La.hasAttribute("jw-played") || La.setAttribute("jw-played", ""), ra.trigger(e.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                }

                function O() {
                    ra.state !== f.COMPLETE && La.currentTime !== La.duration && ra.setState(f.PAUSED)
                }

                function P() {
                    za || La.paused || La.ended || ra.state !== f.LOADING && ra.state !== f.ERROR && (ra.seeking || ra.setState(f.STALLED))
                }

                function Q() {
                    if (xa) {
                        b.log("Error playing media: %o %s", La.error, La.src);
                        var a = "加载失败: 不能播放当前文件";
                        b.isMobile() && b.isHls(La.src) && Ja.tokenEncrypt && !b.isFlvjsSupported() && (a = "当前系统及浏览器环境不支持“token加密”的hls视频播放"), ra.trigger(e.JWPLAYER_MEDIA_ERROR, {
                            message: a,
                            code: "111",
                            detail: La.error,
                            videoSrc: La.src
                ...
                function S(a) {
                    qa = a, ya = T(a);
                    var b = R(a);
                    b && ra.trigger(e.JWPLAYER_MEDIA_LEVELS, {levels: b, currentQuality: ya})
                }

                function T(a) {
                    var b = Math.max(0, ya), c = x.qualityLabel;
                    if (a) for (var d = 0; d < a.length; d++) if (a[d]["default"] && (b = d), c && a[d].label === c) return d;
                    return Ha.reason = "initial choice", Ha.level = {}, b
                }
                ...
                function U(a, c) {
                    ...
                    d.src = qa[ya].file;
                    var e = La.src !== d.src, g = La.getAttribute("jw-loaded"), h = La.hasAttribute("jw-played");
                ...
                function V(a) {
                    Da = null, Ea = -1, Fa = -1, Ha.reason || (Ha.reason = "initial choice", Ha.level = {}), ta = !1, pa = !1, za = l(a);
                    var b = a.preload || "metadata";
                    "none" !== b && La.setAttribute("preload", b);
                    var c = document.createElement("source");
                    c.src = a.file, La.src !== c.src && (La.setAttribute("jw-loaded", "none"), La.src = a.file)
                }

                function W() {
                    La && (ra.disableTextTrack(), La.removeAttribute("crossorigin"), La.removeAttribute("preload"), La.removeAttribute("src"), La.removeAttribute("jw-loaded"), La.removeAttribute("jw-played"), c.emptyElement(La), ya = -1, Ga = null, !q && "load" in La && La.load(), ra.trigger("stop"))
                }

                function X() {
                    for (var a = La.seekable ? La.seekable.length : 0, b = 1 / 0; a--;) b = Math.min(b, La.seekable.start(a));
                    return b
                }

                function Y() {
                    for (var a = La.seekable ? La.seekable.length : 0, b = 0; a--;) b = Math.max(b, La.seekable.end(a));
                    return b
                }

                function Z() {
                    ra.seeking = !1, ra.trigger(e.JWPLAYER_MEDIA_SEEKED)
                }

                function $() {
                    ra.trigger("volume", {volume: Math.round(100 * La.volume)}), ra.trigger("mute", {mute: La.muted})
                }
                ...
                function ba() {
                    if (xa && ra.state !== f.IDLE && ra.state !== f.COMPLETE) {
                        if (n(va), ya = -1, Ba = !0, ra.trigger(e.JWPLAYER_MEDIA_BEFORECOMPLETE), !xa) return;
                        ca()
                    }
                }

                function ca() {
                    n(va), ra.setState(f.COMPLETE), Ba = !1, ra.trigger(e.JWPLAYER_MEDIA_COMPLETE)
                }

                function da(a) {
                    Ca = !0, ga(a), b.isIOS() && (La.controls = !1)
                }

                function ea() {
                    for (var a = -1, b = 0; b < La.audioTracks.length; b++) if (La.audioTracks[b].enabled) {
                        a = b;
                        break
                    }
                    ia(a)
                ...
                function fa(a) {
                    Ca = !1, ga(a), b.isIOS() && (La.controls = !1)
                }

                function ga(a) {
                    ra.trigger("fullscreenchange", {target: a.target, jwstate: Ca})
                }
                ...
                function ha(a) {
                    if (Da = null, a) {
                        if (a.length) {
                            ...
                            -1 === Ea && (Ea = 0, a[Ea].enabled = !0), Da = d.map(a, function (a) {
                                return {name: a.label || a.language, language: a.language}
                            })
                        }
                        ra.addTracksListener(a, "change", ea), Da && ra.trigger("audioTracks", {
                            currentTrack: Ea,
                            tracks: Da
                        })
                    }
                ...
                function ia(a) {
                    La && La.audioTracks && Da && a > -1 && a < La.audioTracks.length && a !== Ea && (La.audioTracks[Ea].enabled = !1, Ea = a, La.audioTracks[Ea].enabled = !0, ra.trigger("audioTrackChanged", {
                        currentTrack: Ea,
                        tracks: Da
                    }))
                }
                ...
                function la() {
                    if ("hls" === qa[0].type) {
                        var a = "video";
                        0 === La.videoHeight && (a = "audio"), ra.trigger("mediaType", {mediaType: a})
                    }
                }

                this.state = f.IDLE, this.seeking = !1, d.extend(this, h, i), this.trigger = function (a, b) {
                    if (xa) return h.trigger.call(this, a, b)
                }, this.setState = function (a) {
                    if (xa) return g.setState.call(this, a)
                };
                var ma, na, oa, pa, qa, ra = this, sa = {
                        click: A,
                        durationchange: B,
                        ended: ba,
                        error: Q,
                        ...
                        timeupdate: D,
                        volumechange: $,
                        webkitbeginfullscreen: da,
                        webkitendfullscreen: fa
                    }, ta = !1, ua = 0, va = -1, wa = -1, xa = !0, ya = -1, za = null, Aa = !!x.sdkplatform, Ba = !1,
                    Ca = !1, Da = null, Ea = -1, Fa = -1, Ga = null, Ha = {level: {}}, Ia = null, Ja = null,
                    Ka = document.getElementById(m), La = Ka ? Ka.querySelector("video") : void 0;
                La = La || document.createElement("video"), La.className = "jw-video jw-reset", this.isSDK = Aa, this.itemTracks = Ga, this.video = La, d.isObject(x.cast) && x.cast.appid && La.setAttribute("disableRemotePlayback", ""), j(sa, La), u || (La.controls = !0, La.controls = !1), La.setAttribute("disableRemotePlayback", ""), La.setAttribute("x-webkit-airplay", "allow"), La.setAttribute("webkit-playsinline", ""), La.setAttribute("playsinline", ""), La.setAttribute("x5-playsinline", ""), this.stop = function () {
                    n(va), xa && (W(), b.isIETrident() && La.pause(), this.setState(f.IDLE))
                }, this.destroy = function () {
                    k(sa, La), this.removeTracksListener(La.audioTracks, "change", ea), this.removeTracksListener(La.textTracks, "change", ra.textTrackChangeHandler), this.remove(), this.off(), Ia && (Ia.destroy(), Ia = null)
                }, this.init = function (a, c) {
                    xa && (Ga = null, qa = a.sources, ya = T(a.sources), a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources), oa = a.starttime || 0, na = a.duration || 0, Ha.reason = "", V(qa[ya]), this.setupSideloadedTracks(a.tracks), Ga = this.itemTracks, Ja = c, b.isHtml5Flv(qa[ya].file, qa[ya].type) && this.initFlvPlayer(), Ja.crossoriginAnonymous && La.setAttribute("crossorigin", "anonymous"))
                }, this.initFlvPlayer = function () {
                    var a = this;
                    Ia && Ia.destroy();
                    var b = {};
                    Ja.minBufferLength > 0 && (b.lazyLoadMaxDuration = Ja.minBufferLength, Ja.minBufferLength < 30 && (b.lazyLoadRecoverDuration = Ja.minBufferLength)), Ia = window.flvjs.createPlayer({
                        type: "flv",
                        isLive: Ja.isLive,
                        url: qa[ya].file
                    }, b), Ia.attachMediaElement(La), Ia.on(e.JWPLAYER_ERROR, function (b, c, d) {
                    ...
                    }), Ia.on(e.JWPLAYER_ALIVE, function () {
                        a.trigger(e.JWPLAYER_ALIVE)
                    }), Ia.on(e.JWPLAYER_NO_LIVE_STREAM, function () {
                        a.trigger(e.JWPLAYER_NO_LIVE_STREAM)
                    })
                }, this.load = function (a) {
                    xa && (S(a.sources), a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources), r && !La.hasAttribute("jw-played") || ra.setState(f.LOADING), U(a.starttime || 0, a.duration || 0))
                }, this.play = function () {
                    return ra.seeking ? (ra.setState(f.LOADING), void ra.once(e.JWPLAYER_MEDIA_SEEKED, ra.play)) : void La.play()
                }, this.pause = function () {
                    n(va), La.pause(), this.setState(f.PAUSED)
                }, this.seek = function (a) {
                    if (xa) if (a < 0 && (a += X() + Y()), 0 === ua && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
                            position: La.currentTime,
                            offset: a
                        }), ta || (ta = !!Y()), ta) {
                        ua = 0;
                        try {
                            ra.seeking = !0, La.currentTime = a
                        } catch (b) {
                            ra.seeking = !1, ua = a
                        }
                    } else ua = a, s && La.paused && La.play()
                    ...
                    return n(va), this.disableTextTrack(), xa = !1, La
                }, this.attachMedia = function () {
                    xa = !0, ta = !1, this.seeking = !1, La.loop = !1, Ba && ca()
                }, this.setContainer = function (a) {
                    ma = a, a.appendChild(La)
                }, this.getContainer = function () {
                    return ma
                }, this.remove = function () {
                    W(), n(va), ma === La.parentNode && ma.removeChild(La), Ia && (Ia.pause(), Ia.unload(), Ia.detachMediaElement())
                }, this.setVisibility = function (b) {
                    b = !!b, b || t ? a.style(ma, {visibility: "visible", opacity: 1}) : a.style(ma, {
                        visibility: "",
                        opacity: 0
                    })
                }, this.resize = function (b, c, d) {
                    if (!(b && c && La.videoWidth && La.videoHeight)) return !1;
                    var e = {objectFit: ""};
                    if ("uniform" === d) {
                        var f = b / c, g = La.videoWidth / La.videoHeight;
                        Math.abs(f - g) < .09 && (e.objectFit = "fill", d = "exactfit")
                    }
                    if (p || t || u || v) {
                        var h = -Math.floor(La.videoWidth / 2 + 1), i = -Math.floor(La.videoHeight / 2 + 1),
                            j = Math.ceil(100 * b / La.videoWidth) / 100, k = Math.ceil(100 * c / La.videoHeight) / 100;
                        "none" === d ? j = k = 1 : "fill" === d ? j = k = Math.max(j, k) : "uniform" === d && (j = k = Math.min(j, k)), e.width = La.videoWidth, e.height = La.videoHeight, e.top = e.left = "50%", e.margin = 0, a.transform(La, "translate(" + h + "px, " + i + "px) scale(" + j.toFixed(2) + ", " + k.toFixed(2) + ")")
                    }
                    return a.style(La, e), !1
                }, this.setFullscreen = function (a) {
                    if (a = !!a) {
                        return !(b.tryCatch(function () {
                            var a = La.webkitEnterFullscreen || La.webkitEnterFullScreen;
                            a && a.apply(La)
                        }) instanceof b.Error) && ra.getFullScreen()
                    }
                    var c = La.webkitExitFullscreen || La.webkitExitFullScreen;
                    return c && c.apply(La), a
                }, ra.getFullScreen = function () {
                    return Ca || !!La.webkitDisplayingFullscreen
                }, this.setCurrentQuality = function (a) {
                    if (ya !== a && a >= 0 && qa && qa.length > a) {
                        ya = a, Ha.reason = "api", Ha.level = {}, this.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {
                            currentQuality: a,
                            levels: R(qa)
                        }), x.qualityLabel = qa[a].label;
                        var c = La.currentTime || 0, d = La.duration || 0;
                        d <= 0 && (d = na), ra.setState(f.LOADING), b.isHtml5Flv(qa[ya].file, qa[ya].type) && this.initFlvPlayer(), U(c, d)
                    }
                    ...
                    return {name: w}
                }, this.setCurrentAudioTrack = ia, this.getAudioTracks = ja, this.getCurrentAudioTrack = ka, this.setPlaybackRate = function (a) {
                    Ja.isLive || (La.playbackRate = a, this.trigger(e.JWPLAYER_PLAYBACKRATE, {playbackRate: a}))
                }
            }
        ...
        d = [c(19), c(112), c(2), c(4), c(3), c(1)], void 0 !== (e = function (a, b, c, d, e, f) {
            return function () {
                ...
                function i(a) {
                    j.trigger(d.JWPLAYER_ERROR, {message: a || "文件加载失败"})
                }
        ...
        var f = c(12), g = c(23), h = d(g), i = c(152), j = c(150), k = c(160), l = d(k);
        b.VERSION = "4.0.5";
        ...
        d = [c(1)], void 0 !== (e = function (a) {
            return function (b, c) {
                ...
                var e = ["getAudioTracks", "getCaptionsList", "getWidth", "getHeight", "getCurrentAudioTrack", "setCurrentAudioTrack", "getCurrentCaptions", "setCurrentCaptions", "getCurrentQuality", "setCurrentQuality", "getQualityLevels", "getVisualQuality", "getConfig", "getState", "getSafeRegion", "isBeforeComplete", "isBeforePlay", "getProvider", "detachMedia"],
                    f = ["setControls", "setFullscreen", "setVolume", "enableGPU", "disableGPU", "setMute", "setCues", "setCaptions", "setToken", "setThumbnails", "setPlaybackRate"];
                a.each(e, function (a) {
                    b[a] = function () {
        ...
        d = [c(2), c(1)], void 0 !== (e = function (a, b) {
            ...
            var h = {
                ...
                playRate: !0,
                playbackRate: 1,
                playRateConfig: [{label: "×1"}, {label: "×1.5"}, {label: "×2"}, {label: "×3"}, {label: "×4"}, {label: "×5"}],
                isLive: !1,
                ...
                setup: function (g, n) {
                    ...
                    function y(a) {
                        ...
                        b.on(q.JWPLAYER_PLAYLIST_LOADED, function (a) {
                            ...
                            a.message = "播放列表加载失败: " + a.message, this.triggerError(a)
                        }, this), b.load(a)
                    }
        ...
        d = [c(20), c(34), c(57), c(41), c(21), c(1), c(2), c(4), c(8), c(16)], void 0 !== (e = function (a, b, d, e, f, g, h, i, j, k) {
            ...
            function q(a) {
                return h.isFlvjsSupported() && (h.isHls(a[0].file) || a[0].sources && h.isHls(a[0].sources[0].file))
            }
            ...
            function s(a, b) {
                if (q(b.get("playlist")) && window.videojs && !window.videojs.Hls) {
        ...
        d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
            ...
            function l(l, w) {
                function x() {
                    wa && (ga(Ha.audioTracks), qa.setTextTracks(Ha.textTracks), Ha.setAttribute("jw-loaded", "data"))
                }

                function y() {
                    wa && Ha.setAttribute("jw-loaded", "started")
                }
                ...
                function C() {
                    p(ua), sa = !0, wa && (qa.state === f.STALLED ? qa.setState(f.PLAYING) : qa.state === f.PLAYING && (ua = setTimeout(Z, q)), Ha.duration === 1 / 0 && 0 === Ha.currentTime || (G(F()), E(Ha.currentTime), D($(), na, ma), qa.state === f.PLAYING && qa.trigger(e.JWPLAYER_MEDIA_TIME, {
                        position: na,
                        duration: ma
                    })))
                }
                ...
                function D(a, b, c) {
                    a === va && c === ma || (va = a, qa.trigger(e.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a,
                        position: b,
                        duration: c
                    }))
                ...
                function G(a) {
                    ma = a, ta && a && a !== 1 / 0 && qa.seek(ta)
                }

                function H() {
                    var a = F();
                    a === 1 / 0 && (a = 0);
                    var b = {duration: a, height: Ha.videoHeight, width: Ha.videoWidth};
                    qa.trigger(e.JWPLAYER_MEDIA_META, b), G(a)
                }
                ...
                function J() {
                    wa && (Ha.muted && (Ha.muted = !1, Ha.muted = !0), Ha.setAttribute("jw-loaded", "meta"), H())
                }

                function K() {
                    oa || (oa = !0, qa.trigger(e.JWPLAYER_MEDIA_BUFFER_FULL))
                }

                function L() {
                    qa.setState(f.PLAYING), Ha.hasAttribute("jw-played") || Ha.setAttribute("jw-played", ""), qa.trigger(e.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                }

                function M() {
                    qa.state !== f.COMPLETE && Ha.currentTime !== Ha.duration && qa.setState(f.PAUSED)
                }

                function N() {
                    Ha.paused || Ha.ended || qa.state !== f.LOADING && qa.state !== f.ERROR && (qa.seeking || qa.setState(f.STALLED))
                }

                function O() {
                    wa && (n.hls && n.hls.reconnecttime ? setTimeout(function () {
                        return qa.load(o)
                    }, 1e3 * n.hls.reconnecttime) : v < n.retryCount && o ? (v++, setTimeout(function () {
                        return qa.load(o)
                    }, 3e3)) : (b.log("Error playing media: %o %s", Ha.error, Ha.src), qa.trigger(e.JWPLAYER_MEDIA_ERROR, {
                        message: "加载失败: 不能播放当前文件",
                        code: "111"
                    })))
                }
                ...
                function Q(a) {
                    pa = a, xa = R(a);
                    var b = P(a);
                    b && qa.trigger(e.JWPLAYER_MEDIA_LEVELS, {levels: b, currentQuality: xa})
                }

                function R(a) {
                    var b = Math.max(0, xa), c = w.qualityLabel;
                    if (a) for (var d = 0; d < a.length; d++) if (a[d]["default"] && (b = d), c && a[d].label === c) return d;
                    return Fa.reason = "initial choice", Fa.level = {}, b
                }
                ...
                function S(a, b) {
                    ...
                    var c = document.createElement("source");
                    c.src = pa[xa].file;
                    var d = Ha.src !== c.src, e = Ha.getAttribute("jw-loaded");
                    if (d || "none" === e || "started" === e) {
                        ma = b, qa.setupSideloadedTracks(Ea), T(pa[xa]);
                        var f = s ? 1e3 : 500;
                        setTimeout(function () {
                            a > 0 && qa.seek(a), m.play(), n.playbackRate > 1 && qa.setPlaybackRate(n.playbackRate)
                        }, f), s && Ha.paused && setTimeout(function () {
                            m.play()
                        }, 2500)
                    } else 0 === a && Ha.currentTime > 0 && (ta = -1, qa.seek(a)), m.play();
                    na = Ha.currentTime, a > 0 && qa.seek(a)
                }

                function T(a) {
                    Ba = null, Ca = -1, Da = -1, Fa.reason || (Fa.reason = "initial choice", Fa.level = {}), sa = !1, oa = !1, a.preload && a.preload !== Ha.getAttribute("preload") && Ha.setAttribute("preload", a.preload);
                    var b = document.createElement("source");
                    b.src = a.file, Ha.src !== b.src && (Ha.setAttribute("jw-loaded", "none"), m.src({
                        src: a.file,
                ...
                function U() {
                    Ha && (qa.disableTextTrack(), Ha.removeAttribute("crossorigin"), Ha.removeAttribute("preload"), Ha.removeAttribute("src"), Ha.removeAttribute("jw-loaded"), Ha.removeAttribute("jw-played"), c.emptyElement(Ha), xa = -1, Ea = null, !r && "load" in Ha && m.load())
                }

                function V() {
                    for (var a = Ha.seekable ? Ha.seekable.length : 0, b = 1 / 0; a--;) b = Math.min(b, Ha.seekable.start(a));
                    return b
                }

                function W() {
                    for (var a = Ha.seekable ? Ha.seekable.length : 0, b = 0; a--;) b = Math.max(b, Ha.seekable.end(a));
                    return b
                }

                function X() {
                    qa.seeking = !1, qa.trigger(e.JWPLAYER_MEDIA_SEEKED)
                }

                function Y() {
                    qa.trigger("volume", {volume: Math.round(100 * Ha.volume)}), qa.trigger("mute", {mute: Ha.muted})
                }
                ...
                function $() {
                    var a = Ha.buffered, c = Ha.duration;
                    return !a || 0 === a.length || c <= 0 || c === 1 / 0 ? 0 : b.between(a.end(a.length - 1) / c, 0, 1)
                }

                function _() {
                    if (wa && qa.state !== f.IDLE && qa.state !== f.COMPLETE) {
                        if (p(ua), xa = -1, za = !0, qa.trigger(e.JWPLAYER_MEDIA_BEFORECOMPLETE), !wa) return;
                        aa()
                    }
                }

                function aa() {
                    p(ua), qa.setState(f.COMPLETE), za = !1, qa.trigger(e.JWPLAYER_MEDIA_COMPLETE)
                }
                ...
                function ca() {
                    for (var a = -1, b = 0; b < Ha.audioTracks.length; b++) if (Ha.audioTracks[b].enabled) {
                        a = b;
                        break
                    }
                    ha(a)
                ...
                function ea(a) {
                    qa.trigger("fullscreenchange", {target: a.target, jwstate: Aa})
                }
                ...
                function ga(a) {
                    if (Ba = null, a) {
                        if (a.length) {
                            ...
                            -1 === Ca && (Ca = 0, a[Ca].enabled = !0), Ba = d.map(a, function (a) {
                                return {name: a.label || a.language, language: a.language}
                            })
                        }
                        qa.addTracksListener(a, "change", ca), Ba && qa.trigger("audioTracks", {
                            currentTrack: Ca,
                            tracks: Ba
                        })
                    }
                ...
                function ha(a) {
                    Ha && Ha.audioTracks && Ba && a > -1 && a < Ha.audioTracks.length && a !== Ca && (Ha.audioTracks[Ca].enabled = !1, Ca = a, Ha.audioTracks[Ca].enabled = !0, qa.trigger("audioTrackChanged", {
                        currentTrack: Ca,
                        tracks: Ba
                    }))
                }
                ...
                function ka() {
                    qa.trigger("mediaType", {mediaType: "video"})
                }

                this.state = f.IDLE, this.seeking = !1, d.extend(this, h, i), this.trigger = function (a, b) {
                    if (wa) return h.trigger.call(this, a, b)
                }, this.setState = function (a) {
                    if (wa) return g.setState.call(this, a)
                }, this.setToken = function (a) {
                    for (var b = {token: {}}, c = 0; c < a.length; c++) b.token[a[c].file] = a[c].tokenText;
                    setTimeout(function () {
                        m.tech({IWillNotUseThisInPlugins: !0}).hls.options(b)
                    }, 0)
                };
                var la, ma, na, oa, pa, qa = this, ra = {
                        click: z,
                        durationchange: A,
                        ended: _,
                        loadstart: y,
                        ...
                        timeupdate: C,
                        volumechange: Y,
                        webkitbeginfullscreen: ba,
                        webkitendfullscreen: da
                    }, sa = !1, ta = 0, ua = -1, va = -1, wa = !0, xa = -1, ya = !!w.sdkplatform, za = !1, Aa = !1,
                    Ba = null, Ca = -1, Da = -1, Ea = null, Fa = {level: {}}, Ga = document.getElementById(l),
                    Ha = Ga ? Ga.querySelector("video") : void 0;
                Ha = Ha || document.createElement("video"), Ha.className = "jw-video jw-reset", m = window.videojs(Ha), this.isSDK = ya, this.itemTracks = Ea, this.video = Ha, d.isObject(w.cast) && w.cast.appid && Ha.setAttribute("disableRemotePlayback", ""), j(ra, Ha), Ha.controls = !0, Ha.controls = !1, Ha.setAttribute("disableRemotePlayback", ""), Ha.setAttribute("x-webkit-airplay", "allow"), Ha.setAttribute("webkit-playsinline", ""), Ha.setAttribute("playsinline", ""), Ha.setAttribute("x5-playsinline", ""), this.stop = function () {
                    p(ua), wa && (U(), b.isIETrident() && m.pause(), this.setState(f.IDLE))
                }, this.destroy = function () {
                    k(ra, Ha), this.removeTracksListener(Ha.audioTracks, "change", ca), this.removeTracksListener(Ha.textTracks, "change", qa.textTrackChangeHandler), this.remove(), this.off()
                }, this.init = function (a, b) {
                    wa && (v = 0, n = b, Ea = null, pa = a.sources, xa = R(a.sources), o = a, a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources), na = a.starttime || 0, ma = a.duration || 0, Fa.reason = "", t = b.isLive, T(pa[xa]), this.setupSideloadedTracks(a.tracks), Ea = this.itemTracks, b.minBufferLength > 0 && (videojs.Hls.MAX_GOAL_BUFFER_LENGTH = b.minBufferLength, b.minBufferLength < 30 && (videojs.Hls.GOAL_BUFFER_LENGTH = b.minBufferLength)))
                }, this.load = function (a) {
                    wa && (Q(a.sources), a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources), qa.setState(f.LOADING), S(a.starttime || 0, a.duration || 0))
                }, this.play = function () {
                    return qa.seeking ? (qa.setState(f.LOADING), void qa.once(e.JWPLAYER_MEDIA_SEEKED, qa.play)) : void m.play()
                }, this.pause = function () {
                    p(ua), m.pause(), this.setState(f.PAUSED)
                }, this.seek = function (a) {
                    if (wa) if (a < 0 && (a += V() + W()), 0 === ta && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
                            position: Ha.currentTime,
                            offset: a
                        }), sa || (sa = !!W()), sa) {
                        ta = 0;
                        try {
                            qa.seeking = !0, m.currentTime(a)
                        } catch (b) {
                            qa.seeking = !1, ta = a
                        }
                    } else ta = a, s && Ha.paused && m.play()
                }, this.volume = function (a) {
                    a = b.between(a / 100, 0, 1), Ha.volume = a
                }, this.enableGPU = function () {
                    throw"只有使用Flash播放才支持开启GPU"
                }, this.disableGPU = function () {
                    throw"只有使用Flash播放才支持开启GPU"
                    ...
                    return p(ua), this.disableTextTrack(), wa = !1, Ha
                }, this.attachMedia = function () {
                    wa = !0, sa = !1, this.seeking = !1, Ha.loop = !1, za && aa()
                }, this.setContainer = function (a) {
                    var c = this;
                    la = a, a.appendChild(Ha), m.on(e.JWPLAYER_MEDIA_LEVELS, function (a) {
                        if (!b.isMutipleHls(pa)) {
                            fa(a.levels), xa = a.currentQuality, _qualityLevels = a.levels;
                            var d = {type: "levels", levels: a.levels, currentQuality: a.currentQuality};
                            c.trigger("levels", d)
                        }
                    }), m.on(e.JWPLAYER_MEDIA_LEVEL_CHANGED, function (a) {
                        if (!b.isMutipleHls(pa)) {
                            fa(a.levels), xa = a.currentQuality, _qualityLevels = a.levels;
                            var d = {type: "levelsChanged", levels: a.levels, currentQuality: a.currentQuality};
                            c.trigger("levelsChanged", d)
                        }
                    }), m.on(e.JWPLAYER_CONNECTING, function (a) {
                        h.trigger.call(c, "connecting", a)
                    }), m.on(e.JWPLAYER_ERROR, O), m.tech({IWillNotUseThisInPlugins: !0}).on(e.JWPLAYER_ALIVE, function () {
                        c.trigger(e.JWPLAYER_ALIVE)
                    }), m.tech({IWillNotUseThisInPlugins: !0}).on(e.JWPLAYER_NO_LIVE_STREAM, function () {
                        c.trigger(e.JWPLAYER_NO_LIVE_STREAM)
                    }), m.tech({IWillNotUseThisInPlugins: !0}).on("retryplaylist", function () {
                        c.trigger(e.JWPLAYER_NO_LIVE_STREAM)
                    })
                }, this.getContainer = function () {
                    return la
                }, this.remove = function () {
                    U(), p(ua), la === Ha.parentNode && la.removeChild(Ha), m.dispose()
                }, this.setVisibility = function (b) {
                    b = !!b, b ? a.style(la, {visibility: "visible", opacity: 1}) : a.style(la, {
                        visibility: "",
                        opacity: 0
                    })
                }, this.resize = function (b, c, d) {
                    if (!(b && c && Ha.videoWidth && Ha.videoHeight)) return !1;
                    var e = {objectFit: ""};
                    if ("uniform" === d) {
                        var f = b / c, g = Ha.videoWidth / Ha.videoHeight;
                        Math.abs(f - g) < .09 && (e.objectFit = "fill", d = "exactfit")
                    }
                    return a.style(Ha, e), !1
                }, this.setFullscreen = function (a) {
                    if (a = !!a) {
                        return !(b.tryCatch(function () {
                            var a = Ha.webkitEnterFullscreen || Ha.webkitEnterFullScreen;
                            a && a.apply(Ha)
                        }) instanceof b.Error) && qa.getFullScreen()
                    }
                    var c = Ha.webkitExitFullscreen || Ha.webkitExitFullScreen;
                    return c && c.apply(Ha), a
                }, qa.getFullScreen = function () {
                    return Aa || !!Ha.webkitDisplayingFullscreen
                }, this.setCurrentQuality = function (a) {
                    if (!(xa === a || a < 0)) if (b.isMutipleHls(pa)) {
                        xa = a, this.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {currentQuality: a, levels: P(pa)});
                        var c = Ha.currentTime || 0, d = Ha.duration || 0;
                        d <= 0 && (d = ma), qa.setState(f.LOADING), S(c, d)
                    } else {
                        var g = m.qualityLevels();
                        g[a] && m.tech({IWillNotUseThisInPlugins: !0}).hls.playlists.media(g[a].id)
                    }
                }, this.getCurrentQuality = function () {
                    return xa
                }, this.getQualityLevels = function () {
                    ...
                    return {name: u}
                }, this.setCurrentAudioTrack = ha, this.getAudioTracks = ia, this.getCurrentAudioTrack = ja, this.setPlaybackRate = function (a) {
                    n.isLive || (Ha.playbackRate = a, this.trigger(e.JWPLAYER_PLAYBACKRATE, {playbackRate: a}))
                }
            }

            var m, n, o, p = window.clearTimeout, q = 256, r = b.isMSIE(), s = b.isFF(), t = !1, u = "videojs", v = 0,
                w = function () {
                };
            return w.prototype = g, l.prototype = new w, l.getName = function () {
                return {name: "videojs"}
            }, l
        }.apply(b, d)) && (a.exports = e)
    }, function (a, b, c) {
                ...
                setup: function () {
                    ...
                    if (d && d[a] && d[a].image) {
                        ...
                        if (l.style.display = "none", m.style.display = "none", "start" === a) {
                            ...
                            m.style.display = "block", m.innerHTML = "广告: " + n + "秒"
                        }
            ...
            return b.extend(p.prototype, c, {
                setup: function () {
                    ...
                    d.on("change:levels", function (a, b) {
                        ...
                        var c = this._model.get("playRateConfig"), d = c.findIndex(function (a) {
                            return a.label === "×" + b
                        });
                    ...
                    return "table" === (getComputedStyle ? getComputedStyle(c) : c.currentStyle).display ? a.bounds(c) : (c.style.visibility = "hidden", c.style.display = "table", b = a.bounds(c),
                        c.style.visibility = c.style.display = "", b)
        ...
        d = [c(2), c(1), c(15)], void 0 !== (e = function (a, b, c) {
            ...
            return b.extend(e.prototype, {
                init: function () {
                    ...
                    c.style(this.element, {animationPlayState: "paused", opacity: 0})
                }, reset: function (b, d) {
            ...
            return function (w, x) {
                ...
                function B(a) {
                    ...
                    switch (Ja || ca(), a.keyCode) {
                        ...
                        case 40:
                            ...
                            break;
                        case 67:
                            var b = w.getCaptionsList(), c = b.length;
                            if (c) {
                                var d = (w.getCurrentCaptions() + 1) % c;
                                w.setCurrentCaptions(d)
                            }
                            break;
                        case 77:
                            w.setMute();
                        ...
                        default:
                            if (a.keyCode >= 48 && a.keyCode <= 59) {
                                var e = a.keyCode - 48, f = e / 10 * x.get("duration");
                                w.seek(f)
                            }
                    }
                ...
                function S() {
                    ...
                    a.addEventListener(c, "mousemove", ca), va = new g(x, na, {useHover: !0}), va.on("click", function () {
                        P({type: b.JWPLAYER_DISPLAY_CLICK}), x.get("controls") && !x.get("flashUI") && w.play({reason: "interaction"})
                    }), va.on("tap", function () {
                ...
                function ga(b, c) {
                    var d = "LIVE" === a.adaptiveType(c) || "DVR" === a.adaptiveType(c);
                ...
                s(la, {
                    ...
                    w.on(b.JWPLAYER_READY, function () {
                        ...
                        Pa.setAltText("正在与服务器建立连接"), a.toggleClass(la, "jw-flag-live", !0)
                    }), x.on("connectFaild", function () {
                        w.stop(), Pa.setAltText("连接已断开，请稍后重试"), a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block"
                    }), x.on("alive", function () {
                        ...
                        w.stop(), Pa.setAltText("直播结束"), a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "block"
                    }), x.on("seekAfterLoadSuccess", function () {
                        Pa.setAltText("自动跳转到上次的播放时间..."), a.addClass(ra.element(), "jw-controlbar-textshow"), setTimeout(function () {
        ...
        b.__esModule = !0;
        var g = c(67), h = e(g), i = c(163), j = d(i), k = c(23), l = d(k), m = c(12), n = e(m), o = c(162), p = e(o),
            q = c(161), r = d(q), s = f();
        ...
        "use strict";
        b.__esModule = !0;
        var d = c(12), e = c(23), f = function (a) {
            return a && a.__esModule ? a : {"default": a}
        }(e);
        b["default"] = function (a) {
