...
class AbstractInnerUserAuth(models.Model):
    user = models.OneToOneField('social_login.SiteUser', related_name='inner_user', on_delete=models.CASCADE, )
...
class AbstractUserInfo(models.Model):
    user = models.OneToOneField('social_login.SiteUser', related_name='user_info', on_delete=models.CASCADE, )
